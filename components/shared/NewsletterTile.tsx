...
export default function Newsletter() {
  return (
    <div className="w-full relative isolate overflow-hidden bg-amber-300 py-16 sm:py-24 lg:py-32">
      <div className="max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-y-16 gap-x-8 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <p className="mt-4 text-lg leading-8 text-gray-500">{subtitle}</p>
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                className="min-w-0 flex-auto rounded-md border-0 bg-amber-50 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-white/10 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6"
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              ...
              <dd className="mt-2 leading-7 text-gray-400">{weeklyInfo}</dd>
            </div>
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-white/5 p-2 ring-1 ring-white/10">
                <HandRaisedIcon
              ...
              <dd className="mt-2 leading-7 text-gray-400">{noSpamInfo}</dd>
            </div>
          </dl>
        </div>
      </div>
