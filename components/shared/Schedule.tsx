...
<div className='flex items-center p-4'><button className='rounded-md p-2 bg-indigo-200 font-bold text-white'><a href={yogaClass.registerUrl}>Sign Up &rarr;</a></button>
</div></dl>
