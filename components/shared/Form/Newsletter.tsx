...
export default function Subscribe() {
  ...
  return (
    <div className="border border-brand-300 rounded p-6 my-4 w-full dark:border-gray-800 bg-brand-200/[.50] dark:bg-black-charcoal">
      ...
      <div className="mt-6 lg:mt-0 flex max-w-md gap-x-4 ">
        <input
          ref={inputEl}
        ...
        />
        <button
          className="flex-none rounded-md bg-emerald-600 py-2.5 px-3.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
          type="submit"
        >
